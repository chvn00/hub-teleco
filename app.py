...
APPS = [
    ...
    },
    {
        ...
        "submodulos": [
            {"nombre": "Investigación",     "icono": "bi-journal-richtext", "color": "#1565C0", "url": os.environ.get("URL_INVESTIGACION", "#")},
            {"nombre": "Proyección Social", "icono": "bi-people",           "color": "#2E7D32", "url": os.environ.get("URL_PROYECCION",    "#")},
            {"nombre": "Calidad",           "icono": "bi-patch-check",      "color": "#E65100", "url": os.environ.get("URL_CALIDAD",       "#")},
        ],
    },
]
